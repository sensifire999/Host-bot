...
@app.route('/')
def home():
    return "I'am PYTHON HOSTING BOT"
...
# --- Configuration ---
TOKEN = '8201984239:AAF1U0MDWJR25eKVUw65AwEd5T5LvgXhg4M' # Replace with your actual token
OWNER_ID = 8084057668 # Replace with your Owner ID
ADMIN_ID = 8084057668 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@desi_anand_yt' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/+8BG1SjUsrIAzODg1' # Replace with your update channel link
